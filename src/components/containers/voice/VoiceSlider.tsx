            ...
            <div className="section__header--secondary">
              <div className="row align-items-center items-gap">
                <div className="col-12 col-lg-8">
                  ...
                  <p className="fw-5 text-lg">Our all-in-one video platform turns your ideas into action. Make, manage, and share videos and virtual events that move your audience.One video platform.</p>
                </div>
